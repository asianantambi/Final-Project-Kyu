...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Make Your Payment To Book")),
      body: Stack(
        children: [
          Padding(
  ...
  void _makePayment(BuildContext context, String email, String amount) async {
    try {
      Flutterwave flutterwave = Flutterwave.forUIPayment(
          ...
          encryptionKey: "FLWSECK_TESTb0ce61f15b53",
          publicKey: "FLWPUBK_TEST-9ad67c757acf6a4d9d58b624464e32fe-X",
          currency: "UGX",
          amount: amount,
          email: "$email",
          fullName: "Kenneth Wakoko",
          txRef: _ref,
          isDebugMode: true,
          phoneNumber: "+256705456468",
