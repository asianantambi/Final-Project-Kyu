...
class MakePayment1 extends StatefulWidget {
  const MakePayment1({Key key}) : super(key: key);

  @override
  State<MakePayment1> createState() => _MakePayment1State();

  void _MakePayment1Widget() {}
}

class _MakePayment1State extends State<MakePayment1> {
  // // flutterwave
