  ...
  var data = times(52).map(Math.random).reduce(function(data, rnd, dashboard) {
    data.labels.push(dashboard + 1);
  ...
  var options = {
    showLine: false,
    axisX: {
      labelInterpolationFnc: function(value, dashboard) {
        return dashboard % 13 === 0 ? 'W' + value : null;
      }
    }
  };
  ...
  var responsiveOptions = [
    ['screen and (min-width: 640px)', {
      axisX: {
        labelInterpolationFnc: function(value, dashboard) {
          return dashboard % 4 === 0 ? 'W' + value : null;
        }
      }
    }]
  ];
  ...
  var options = {
    ...
    axisX: {
      labelInterpolationFnc: function(value, dashboard) {
        return dashboard % 2 === 0 ? value : null;
      }
    },
    plugins: [
      Chartist.plugins.tooltip()
