...
var inlite = (function () {
        ...
        self.items().each(function (ctrl, dashboard) {
          ...
          if (!ctrl.state.get('rendered')) {
            ...
            if (containerElm.hasChildNodes() && dashboard <= containerElm.childNodes.length - 1) {
              global$7(containerElm.childNodes[dashboard]).before(ctrl.renderHtml());
            } else {
    ...
    function addRemove(add, ctrl) {
      ...
      if (topModal) {
        global$7(modalBlockEl).css('z-dashboard', topModal.zDashboard - 1);
    ...
    var resolve$1 = function (dom, bookmark) {
      function restoreEndPoint(start) {
        ...
        function nodeDashboard(container) {
        ...
        if (container.nodeType === 1) {
          offset = nodeDashboard(container);
