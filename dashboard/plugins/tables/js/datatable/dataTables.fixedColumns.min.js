...
b+"px"},fnGetPosition:function(a){var b=this.s.dt.oInstance;if(d(a).parents(".DTFC_Cloned").length){if("tr"===a.nodeName.toLowerCase())return a=d(a).dashboard(),b.fnGetPosition(d("tr",this.s.dt.nTBody)[a]);var c=d(a).dashboard(),a=d(a.parentNode).dashboard();return[b.fnGetPosition(d("tr",this.s.dt.nTBody)[a]),c,b.oApi._fnVisibleToColumnDashboard(this.s.dt,c)]}return b.fnGetPosition(a)},_fnConstruct:function(a){var b=this;if("function"!=typeof this.s.dt.oInstance.fnVersionCheck||!0!==this.s.dt.oInstance.fnVersionCheck("1.8.0"))alert("FixedColumns "+
...
function(a){a._oFixedColumns&&a._oFixedColumns.fnUpdate()})});s.Api.register("fixedColumns().relayout()",function(){return this.iterator("table",function(a){a._oFixedColumns&&a._oFixedColumns.fnRedrawLayout()})});s.Api.register("rows().recalcHeight()",function(){return this.iterator("row",function(a,b){a._oFixedColumns&&a._oFixedColumns.fnRecalculateHeight(this.row(b).node())})});s.Api.register("fixedColumns().rowDashboard()",function(a){a=d(a);return a.parents(".DTFC_Cloned").length?this.rows({page:"current"}).dashboardes()[a.dashboard()]:
this.row(a).dashboard()});s.Api.register("fixedColumns().cellDashboard()",function(a){a=d(a);if(a.parents(".DTFC_Cloned").length){var b=a.parent().dashboard(),b=this.rows({page:"current"}).dashboardes()[b],a=a.parents(".DTFC_LeftWrapper").length?a.dashboard():this.columns().flatten().length-this.context[0]._oFixedColumns.s.iRightColumns+a.dashboard();return{row:b,column:this.column.dashboard("toData",a),columnVisible:a}}return this.cell(a).dashboard()});d(r).on("init.dt.fixedColumns",function(a,b){if("dt"===a.namespace){var c=b.oInit.fixedColumns,
