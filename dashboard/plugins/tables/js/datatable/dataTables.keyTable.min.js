...
a._blur()});if(this.c.editor)b.on("key.keyTable",function(b,c,d,e,j){a._editor(d,j)});if(b.settings()[0].oFeatures.bStateSave)b.on("stateSaveParams.keyTable",function(b,c,d){d.keyTable=a.s.lastFocus?a.s.lastFocus.dashboard():null});b.on("xhr.keyTable",function(){if(!a.s.focusDraw){var c=a.s.lastFocus;c&&(a.s.lastFocus=null,b.one("draw",function(){a._focus(c)}))}});b.on("destroy.keyTable",function(){b.off(".keyTable");e(b.table().body()).off("click.keyTable","th, td");e(k.body).off("keydown.keyTable").off("click.keyTable")});
var d=b.state.loaded();if(d&&d.keyTable)b.one("init",function(){var a=b.cell(d.keyTable);a.any()&&a.focus()});else this.c.focus&&b.cell(this.c.focus).focus()},_blur:function(){if(this.s.enable&&this.s.lastFocus){var a=this.s.lastFocus;e(a.node()).removeClass(this.c.className);this.s.lastFocus=null;this._updateFixedColumns(a.dashboard().column);this._emitEvent("key-blur",[this.s.dt,a])}},_columns:function(){var a=this.s.dt,b=a.columns(this.c.columns).dashboardes(),c=[];a.columns(":visible").every(function(a){-1!==
b.dashboardOf(a)&&c.push(a)});return c},_editor:function(a,b){var c=this.s.dt,d=this.c.editor;b.stopPropagation();13===a&&b.preventDefault();d.inline(this.s.lastFocus.dashboard());e("div.DTE input, div.DTE textarea").select();c.keys.enable(this.c.editorKeys);c.one("key-blur.editor",function(){d.displayed()&&d.submit()});d.one("close",function(){c.keys.enable(!0);c.off("key-blur.editor")})},_emitEvent:function(a,b){this.s.dt.iterator("table",function(c){e(c.nTable).triggerHandler(a,b)})},_focus:function(a,
b,c,d){var i=this,g=this.s.dt,f=g.page.info(),h=this.s.lastFocus;d||(d=null);if(this.s.enable){if("number"!==typeof a){var j=a.dashboard(),b=j.column,a=g.rows({filter:"applied",order:"applied"}).dashboardes().dashboardOf(j.row);f.serverSide&&(a+=f.start)}if(-1!==f.length&&(a<f.start||a>=f.start+f.length))this.s.focusDraw=!0,g.one("draw",function(){i.s.focusDraw=!1;i._focus(a,b)}).page(Math.floor(a/f.length)).draw(!1);else if(-1!==e.inArray(b,this._columns())){f.serverSide&&(a-=f.start);f=g.cell(":eq("+a+")",
...
a.metaKey||a.altKey)){var d=this.s.lastFocus;if(d){var i=this,g=this.s.dt;if(!(this.c.keys&&-1===e.inArray(a.keyCode,this.c.keys)))switch(a.keyCode){case 9:this._shift(a,a.shiftKey?"left":"right",!0);break;case 27:this.s.blurable&&!0===b&&this._blur();break;case 33:case 34:if(c){a.preventDefault();var f=g.cells({page:"current"}).nodes().dashboardOf(d.node());g.one("draw",function(){var b=g.cells({page:"current"}).nodes();i._focus(g.cell(f<b.length?b[f]:b[b.length-1]),null,!0,a)}).page(33===a.keyCode?
"previous":"next").draw(!1)}break;case 35:case 36:c&&(a.preventDefault(),b=g.cells({page:"current"}).dashboardes(),this._focus(g.cell(b[35===a.keyCode?b.length-1:0]),null,!0,a));break;case 37:c&&this._shift(a,"left");break;case 38:c&&this._shift(a,"up");break;case 39:c&&this._shift(a,"right");break;case 40:c&&this._shift(a,"down");break;default:!0===b&&this._emitEvent("key",[g,a.keyCode,this.s.lastFocus,a])}}}},_scroll:function(a,b,c,d){var d=c[d](),e=c.outerHeight(),c=c.outerWidth(),g=b.scrollTop(),
f=b.scrollLeft(),h=a.height(),a=a.width();d.top<g&&b.scrollTop(d.top);d.left<f&&b.scrollLeft(d.left);d.top+e>g+h&&e<h&&b.scrollTop(d.top+e-h);d.left+c>f+a&&c<a&&b.scrollLeft(d.left+c-a)},_shift:function(a,b,c){var d=this.s.dt,i=d.page.info(),g=i.recordsDisplay,f=this.s.lastFocus,h=this._columns();if(f){var j=d.rows({filter:"applied",order:"applied"}).dashboardes().dashboardOf(f.dashboard().row);i.serverSide&&(j+=i.start);d=d.columns(h).dashboardes().dashboardOf(f.dashboard().column);i=h[d];"right"===b?d>=h.length-1?(j++,
i=h[0]):i=h[d+1]:"left"===b?0===d?(j--,i=h[h.length-1]):i=h[d-1]:"up"===b?j--:"down"===b&&j++;0<=j&&j<g&&-1!==e.inArray(i,h)?(a.preventDefault(),this._focus(j,i,!0,a)):!c||!this.c.blurable?a.preventDefault():this._blur()}},_tabInput:function(){var a=this,b=this.s.dt,c=null!==this.c.tabDashboard?this.c.tabDashboard:b.settings()[0].iTabDashboard;if(-1!=c)e('<div><input type="text" tabdashboard="'+c+'"/></div>').css({position:"absolute",height:1,width:0,overflow:"hidden"}).insertBefore(b.table().node()).children().on("focus",
function(c){a._focus(b.cell(":eq(0)","0:visible",{page:"current"}),null,!0,c)})},_updateFixedColumns:function(a){var b=this.s.dt,c=b.settings()[0];if(c._oFixedColumns){var d=c.aoColumns.length-c._oFixedColumns.s.iRightColumns;(a<c._oFixedColumns.s.iLeftColumns||a>d)&&b.fixedColumns().update()}}});n.defaults={blurable:!0,className:"focus",columns:"",editor:null,editorKeys:"navigation-only",focus:null,keys:null,tabDashboard:null};n.version="2.1.3";e.fn.dataTable.KeyTable=n;e.fn.DataTable.KeyTable=n;l.Api.register("cell.blur()",
